...
public class MainActivity extends Activity implements ActionBar.OnNavigationListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter = new NavDrawerListAdapter(getApplicationContext(),menuItems);//adapter oluþturuyoruz
		...
		{//menü aýlýp kapandýðýnda action bar title deðiþimi
			public void onDrawerClosed(View view) { //acýkken uygulama adý gözükecek
	...
	private void displayView(int position) { //gelen positiona göre ilgili fragmentý çaðýrýyor
	...
	public void dataChanges(int i){//Mesaj sayýsý veya bildirim sayýsý deðiþtiðinde çaðýrýlýyor
		int sayi=0;
		...
		menuItems.set(i, new NavDrawerItem(menuList[i], menuIconList.getResourceId(i, -1), true, ""+sayi));//menüdeki deðer deðiþtiriliyor
		adapter.notifyDataSetChanged();//adapter basþtan oluþturuluor.Yeni deðerlere göre
	}
